                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                <h5 class="text-primary c_title" style="color: #2c666e!important;">Welcome Back !</h5>
                                <p class="text-muted">Sign in to continue to Myngly.</p>
                            </div>
                            <div class="p-2 mt-4">
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mt-3 text-end">
                                        <button class="btn btn-primary w-sm waves-effect waves-light c_btn"
                                                type="submit">Log
                                            In
                                        </button>
                                    </div>
