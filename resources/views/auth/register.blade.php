                ...
                <div class="col-lg-12">
                    <div class="text-center">
                        <a href="{{ url('index') }}" class="mb-5 d-block auth-logo">
                            <img src="{{ URL::asset('/assets/images/logo-dark.png?'). config('app.version') }}" alt="" height="22"
                                class="logo logo-dark">
                            <img src="{{ URL::asset('/assets/images/logo-light.png?'). config('app.version') }}" alt="" height="22"
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Get your free Myngly account now.</p>
                            </div>
                            <div class="p-2 mt-4">
                    ...
                    <div class="mt-5 text-center">
                        <p>© <script>
                            ...
                            </script> Myngly. Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                    </div>
