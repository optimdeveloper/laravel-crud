...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <br><br>
                        <form autocomplete="off" method="POST" class="form-horizontal" action="{{ route('logtruncate') }}">
                            @csrf
                            <button type="submit" name="{{ route('logtruncate') }}" class="btn waves-effect waves-light sweet-warning delete" style="background-color: #2c666e; color: white">
                                Clear
                            </button>
                        </form>
                        <div class="col-sm-8">
    ...
    @section('script')
        ...
        <!-- tables -->
        <script src="{{ URL::asset('/assets/js/pages/table-logs.init.js?') . config('app.version') }}"></script>
    @endsection
